...
const command = {
    ...
    data: new discord_js_1.SlashCommandBuilder().addUserOption(option => option.setName("user")
        .setDescription((0, langtools_1.getMessage)("cmd_kiss_option_user_desc", types_1.localization.en))
        .setNameLocalizations((0, langtools_1.getFullDictOf)("cmd_kiss_option_user_name"))
        .setDescriptionLocalizations((0, langtools_1.getFullDictOf)("cmd_kiss_option_user_name"))
        .setRequired(true)),
    callback: async (client, interaction, loc) => {
        ...
        let emb = new discord_js_1.EmbedBuilder().setTimestamp().setFooter({
            ...
            .setTitle((0, langtools_1.getMessage)("cmd_kiss_result_kissed_name", loc)).setDescription((0, langtools_1.parseMessage)("cmd_kiss_result_kissed_desc", loc, { firstUserID: interaction.user.id, secondUserID: mentionedUser.id }));
        const fromApi = await axios_1.default.get('https://api.otakugifs.xyz/gif?reaction=kiss&format=gif');
